    ...
    <div class="absolute rounded border p-1 bg-white shadow-xl">
      <div class="w-full h-full border rounded p-4">
        <form @submit.prevent="submit" class="p-4">
          <h1 class="text-center font-bold text-orange-600">
            Shorten Your Url
          </h1>
          ...
          <i
            @click="close"
            class="fas fa-times-circle text-gray-600 cursor-pointer float-left my-1"
          ></i>
          <i
            @click="submit"
            class="fas fa-paper-plane text-orange-600 cursor-pointer float-right my-1"
          ></i>
        </form>
      </div>
    </div>
